...
def assign_marker_positions(marker_positions):
    ...
    bottom_right_y = round(marker_positions[0]['bottom right corner'][1], 2)
    top_left_x = round(marker_positions[0]['top left corner'][0], 2)
    top_left_y = round(marker_positions[0]['top left corner'][1], 2)
    top_right_x = round(marker_positions[0]['top right corner'][0], 2)
    top_right_y = round(marker_positions[0]['top right corner'][1], 2)
...
def rotate_video():
        ...
        # rotation possible with the current shape of the video? 
